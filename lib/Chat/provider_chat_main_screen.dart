...
class ProviderMainChatScreen extends StatefulWidget {
  const ProviderMainChatScreen({Key? key}) : super(key: key);

  @override
  _ProviderMainChatScreenState createState() => _ProviderMainChatScreenState();
}

class _ProviderMainChatScreenState extends State<ProviderMainChatScreen> {
